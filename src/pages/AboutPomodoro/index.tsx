    ...
    <MainTemplate>
      <Container>
        <GenericHtml>
          ...
          <img src="https://placehold.co/1920x1080" alt="Imagem de testes" />

          <h2>Como funciona o Pomodoro tradicional?</h2>
          <ul>
            <li>
              <strong>1. Defina uma tarefa</strong> que voçê deseja realizar.
            </li>
            <li>
              <strong>2. Trabalhe nela por 25 minutos</strong> sem interrupcões.
            </li>
            <li>
              <strong>3. Faça uma pausa curta de 5 minutos</strong>
            </li>
            <li>
              <strong>4. A cada 4 ciclos, faca uma pausa longa</strong>{" "}
          ...
          <p>
            Nosso app segue o conseito original, mas com algumas melhorias e
            personalizações para deixar o processo ainda mais eficiente:
          </p>
          ...
          <p>
            A cada ciclo completo, uma nova task é adicionada automaticamente ao
          ...
          <ul>
            ...
            <li>
              Ciclo <strong>8</strong>: Descanso longo especial, para resetar o
              ciclo completo.
            </li>
          </ul>
          ...
          <p>
            <strong>Pronto para focar?</strong> Bora lá{" "}
